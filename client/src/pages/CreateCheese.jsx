...
export default function CreateCheese() {
  ...
  const handleSubmit = async (e)=>{
    e.preventDefault()
    try {
      const res = await fetch('/api/cheese/createcheese', {
        method: 'POST',
        headers: {
      ...
      if (!res.ok) {
        setPublishError('Failed to create the cheese');
        return;
      }
      if (res.ok) {
      ...
      setPublishError('Failed to create the pizza cheese');
  ...
  return (
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      <h1 className='text-center text-3xl my-7 font-semibold'>Create a cheese 🧀</h1>
