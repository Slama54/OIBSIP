...
export default function CreateMeat() {
  ...
  const handleSubmit = async (e)=>{
    e.preventDefault()
    try {
      const res = await fetch('/api/meat/createmeat', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      <h1 className='text-center text-3xl my-7 font-semibold'>Create a Meat 🥩 </h1>
