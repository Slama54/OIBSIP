...
export default function Signup() {
  ...
  const handleSubmit= async (e)=>{
    e.preventDefault()
    if(!formData.username || !formData.email || !formData.password || !formData.phone || !formData.address ){
          ...
          <div className="flex-1">
            <form className="flex flex-col gap-4"onSubmit={handleSubmit} >
               ...
               <div >
                ...
                <TextInput type="number" placeholder="+216 " id="phone"onChange={handleChange}/>
